...
public class EarthquakeCityMap extends PApplet {
	...
	public static final float MARKER_SIZE_MULTIPLIER = 3;
	...
	*/
	...
	{  
		...
		marker.setRadius(mag*MARKER_SIZE_MULTIPLIER);
	...
	{	
		...
		fill(0);
		text("4.0+ Magnitude", 65,185);
		fill(0,0,255);
		ellipse(50,240,5,5);
		fill(0);
		text("Below 4.0", 65,245);
	}
}
